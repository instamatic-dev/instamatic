...
from instamatic.grid.geometry import PeriodicConvexPolygonGridGeometry, WindowType
...
class HexagonalGridGeometry(PeriodicConvexPolygonGridGeometry[HexagonalWindow]):
