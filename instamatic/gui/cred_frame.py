...
class ExperimentalcRED(LabelFrame):
    ...
    def __init__(self, parent):
        ...
        Checkbutton(frame, text="XDS (.smv)", variable=self.var_save_xds).grid(row=5, column=2, sticky="EW")
        Checkbutton(frame, text="DIALS (.smv)", variable=self.var_save_dials).grid(row=6, column=3, sticky="EW")
