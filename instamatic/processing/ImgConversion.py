...
def export_dials_variables(path, *, sequence=(), missing=(), rotation_xyz=None):
    ...
    with open(str(path / "dials_variables.sh"), "w",  newline='\n') as f:
    ...
    with open(str(path / "dials_variables.bat"), "w", newline='\n') as f:
...
class ImgConversion(object):
    ...
    def write_ed3d(self, path):
        ...
        with open(str(path / "1.ed3d"), 'w') as f:
    ...
    def write_xds_inp(self, path):
        ...
        with open(str(path / 'XDS.INP'),'w') as f:
            print(s, file=f)
    ...
    def write_beam_centers(self, drc):
        ...
        np.savetxt(str(drc / "beam_centers.txt"), centers, fmt="%10.4f")
    ...
    def write_pets_inp(self, path):
        ...
        with open(str(path / "pets.pts"), "w") as f:
            date = str(time.ctime())
